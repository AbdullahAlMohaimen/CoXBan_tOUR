...
{
	partial class AdminForgetPassword
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.txt_ConfirmPassword = new MaterialSkin.Controls.MaterialMaskedTextBox();
			this.UserForgetPass = new System.Windows.Forms.Button();
			...
			this.button2.BackgroundImage = global::CoXBan_tOUR.Properties.Resources.back1;
			...
			this.label3.Image = global::CoXBan_tOUR.Properties.Resources.secure;
			this.label3.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.label3.Location = new System.Drawing.Point(33, 401);
			...
			// txt_ConfirmPassword
			// 
			this.txt_ConfirmPassword.AllowPromptAsInput = true;
			this.txt_ConfirmPassword.AnimateReadOnly = false;
			this.txt_ConfirmPassword.AsciiOnly = false;
			this.txt_ConfirmPassword.BackgroundImageLayout = System.Windows.Forms.ImageLayout.None;
			this.txt_ConfirmPassword.BeepOnError = false;
			this.txt_ConfirmPassword.CutCopyMaskFormat = System.Windows.Forms.MaskFormat.IncludeLiterals;
			this.txt_ConfirmPassword.Depth = 0;
			this.txt_ConfirmPassword.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txt_ConfirmPassword.HidePromptOnLeave = false;
			this.txt_ConfirmPassword.HideSelection = true;
			this.txt_ConfirmPassword.Hint = "Enter Confirm Password";
			this.txt_ConfirmPassword.InsertKeyMode = System.Windows.Forms.InsertKeyMode.Default;
			this.txt_ConfirmPassword.LeadingIcon = null;
			this.txt_ConfirmPassword.Location = new System.Drawing.Point(39, 429);
			this.txt_ConfirmPassword.Mask = "";
			this.txt_ConfirmPassword.MaxLength = 32767;
			this.txt_ConfirmPassword.MouseState = MaterialSkin.MouseState.OUT;
			this.txt_ConfirmPassword.Name = "txt_ConfirmPassword";
			this.txt_ConfirmPassword.PasswordChar = '*';
			this.txt_ConfirmPassword.PrefixSuffixText = null;
			this.txt_ConfirmPassword.PromptChar = '_';
			this.txt_ConfirmPassword.ReadOnly = false;
			this.txt_ConfirmPassword.RejectInputOnFirstFailure = false;
			this.txt_ConfirmPassword.ResetOnPrompt = true;
			this.txt_ConfirmPassword.ResetOnSpace = true;
			this.txt_ConfirmPassword.RightToLeft = System.Windows.Forms.RightToLeft.No;
			...
			this.txt_ConfirmPassword.SkipLiterals = true;
			...
			this.txt_ConfirmPassword.TextMaskFormat = System.Windows.Forms.MaskFormat.IncludeLiterals;
			this.txt_ConfirmPassword.TrailingIcon = null;
			this.txt_ConfirmPassword.UseSystemPasswordChar = false;
			this.txt_ConfirmPassword.ValidatingType = null;
			// 
			// UserForgetPass
			// 
			this.UserForgetPass.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.UserForgetPass.BackColor = System.Drawing.Color.Brown;
			this.UserForgetPass.BackgroundImageLayout = System.Windows.Forms.ImageLayout.None;
			this.UserForgetPass.FlatStyle = System.Windows.Forms.FlatStyle.Popup;
			this.UserForgetPass.Font = new System.Drawing.Font("Tahoma", 14.25F, System.Drawing.FontStyle.Bold);
			this.UserForgetPass.Location = new System.Drawing.Point(39, 494);
			this.UserForgetPass.Name = "UserForgetPass";
			this.UserForgetPass.Size = new System.Drawing.Size(284, 32);
			this.UserForgetPass.TabIndex = 25;
			...
			this.label4.Location = new System.Drawing.Point(85, 546);
			this.label4.Name = "label4";
			this.label4.Size = new System.Drawing.Size(195, 18);
			this.label4.TabIndex = 26;
			this.label4.Text = "This Page Only for Admin";
			// 
			// AdminForgetPassword
			// 
			...
			this.Controls.Add(this.UserForgetPass);
		...
		private MaterialSkin.Controls.MaterialMaskedTextBox txt_ConfirmPassword;
		private System.Windows.Forms.Button UserForgetPass;
